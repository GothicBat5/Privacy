...
impl KeyCache {
	...
	pub fn set_current_user_group_key(&self, new_user_group_key: VersionedAesKey) {
		...
		match current_user_group_key_lock.as_ref() {
			...
			{
				log::warn!("Tried to set an outdated user group key with version {}; current user group key version: {}",
	...
	pub fn get_group_key_for_version(&self, group_id: &GeneratedId,
		version: i64,
